...
namespace Jiminny\OAuth2\Client\Test\Provider;
...
class DialpadTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->provider = new \Jiminny\OAuth2\Client\Provider\Dialpad([
    ...
    {
        $this->assertEquals('https://dialpad.com', $this->provider->getHost());
    }

    public function testUserProvidedSandboxHost()
    {
        ...
        $this->assertEquals('https://sandbox.dialpad.com', $provider->getHost());
    }
    ...
    public function testUserData()
    {
        ...
        $userId = $resourceOwnerArray['id'];
        $name = $resourceOwnerArray['name'],
